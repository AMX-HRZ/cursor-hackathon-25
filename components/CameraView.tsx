    ...
    <div className="relative w-full max-w-[640px] mx-auto">
      ...
      <div className="nokia-border bg-[#1a1a1a] p-2">
        ...
        <div className="flex justify-between items-center mb-2 px-2 py-1 bg-[#0a0a0a] border border-[#333]">
          <span className="text-[#00ff00] text-sm tracking-wider">
            MEND-AR CAM v1.0
          </span>
        ...
        <div className="relative aspect-[4/3] bg-black overflow-hidden">
          {error ? (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#0a0a0a]">
              <div className="text-[#ff0040] text-xl mb-4 text-glow">
                ⚠ ERROR
              </div>
        ...
        <div className="flex justify-between items-center mt-2 px-2 py-1 bg-[#0a0a0a] border border-[#333]">
          ...
          <button
            ...
            className="text-[#00ffff] text-xs tracking-wider hover:text-[#00ff00] transition-colors"
          >
      ...
      <div className="mt-4 text-center">
        <p className="text-[#666] text-sm">POSITION DAMAGED AREA IN CENTER</p>
